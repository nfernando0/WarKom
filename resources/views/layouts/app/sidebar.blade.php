    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="users" :href="route('community.index')"
                ...
                @endphp
                <flux:sidebar.item icon="chat-bubble-left-right" :href="route('chat.index')"
                    :current="request()->routeIs('chat.*')" :badge="$unreadCount > 0 ? (string)$unreadCount : null" wire:navigate>
                    {{ __('Pesan') }}
                </flux:sidebar.item>
                @php
